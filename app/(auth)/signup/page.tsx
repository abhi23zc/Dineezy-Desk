  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] dark:bg-[#000000] font-sans text-[#09090B] dark:text-[#FAFAFA] transition-colors duration-150">
      <div className="w-full max-w-[360px] bg-[#FFFFFF] dark:bg-[#0A0A0A] rounded-[8px] border border-[#E4E4E7] dark:border-[#27272A] p-[24px] transition-colors duration-150">
        ...
        {/* Success message */}
        {success && (
          <div className="mb-[16px] px-[12px] py-[10px] rounded-[6px] bg-[#ECFDF5] dark:bg-[rgba(16,185,129,0.1)] border border-[#A7F3D0] dark:border-[rgba(16,185,129,0.3)] text-[12px] text-[#065F46] dark:text-[#34D399]">
            {success}
          </div>
        )}

        {/* Email Form */}
        <form className="flex flex-col gap-[16px]" onSubmit={handleEmailSignup}>
          <div className="flex flex-col">
            <label htmlFor="name" className="text-[12px] font-medium text-[#52525B] dark:text-[#A1A1AA] mb-[6px]">Full name</label>
            <input
              type="text"
              id="name"
          ...
          <div className="flex flex-col">
            <label htmlFor="password" className="text-[12px] font-medium text-[#52525B] dark:text-[#A1A1AA] mb-[6px]">Password</label>
            <input
              type="password"
              id="password"
              placeholder="••••••••"
        ...
        <div className="mt-[24px] text-center">
          <p className="text-[13px] text-[#52525B] dark:text-[#A1A1AA]">
            ...
            <Link href="/login" className="text-[#09090B] dark:text-[#FAFAFA] font-medium hover:underline cursor-pointer">
              Log in
            </Link>
          </p>
        </div>
