  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className="w-[14px] h-[14px] transition-all dark:-rotate-90 dark:scale-0"
      >
      ...
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="absolute w-[14px] h-[14px] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100"
      >
